...
Breeds.skavevn_dummy_clan_rat = table.create_copy(Breeds.skavevn_dummy_clan_rat, breed_data)
Breeds.skaven_dummy_clan_rat.size_variation_range = { 1.2, 1.2 }
...
BreedActions.skavevn_dummy_clan_rat = table.create_copy(BreedActions.skavevn_dummy_clan_rat, action_data)