...
Breeds.skaven_dummy_clan_rat.behavior = "storm_vermin_commander"
Breeds.skaven_dummy_clan_rat.killfeed_fold_with = "skaven_storm_vermin"
...
BreedActions.skaven_dummy_clan_rat.give_command = {}