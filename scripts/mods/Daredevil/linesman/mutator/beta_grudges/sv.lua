...
Breeds.skaven_dummy_slave.behavior = "storm_vermin_commander"
Breeds.skaven_dummy_slave.killfeed_fold_with = "skaven_storm_vermin"
...
BreedActions.skaven_dummy_slave.give_command = {}